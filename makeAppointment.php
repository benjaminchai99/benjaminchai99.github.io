...
<html lang="en">
  ...
  <body>
  <form action="selectCollector.php" method="post">
      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-md-12 text-center" data-aos="fade">
            ...
            <h2 class="site-section-heading text-uppercase text-center font-secondary">STEP 1: SELECT A MATERIAL</h2>
          </div>
        </div>

        <?php
          $mysqli = new mysqli('localhost','root','','secondchancedb') or die(mysqli_error($mysqli));
          $result = $mysqli->query("SELECT DISTINCT m.materialID, materialName, materialType, description, pointsPerKg FROM material m, collectorMaterials c WHERE m.materialID = c.materialID") or die($mysqli->error);
        ?>
        <div class="row justify-content-center">
          <table class="table table-hover">
            ...
            <tr>
              ...
              <td>
              <a class="btn btn-success" href ="selectCollector.php?select=<?php echo $row['materialID'];?>">Select Material</a>
